...
seqkit seq $f1 -m 100 -M 2000 > ${file_base}_filtered.fastq

f1=${file_base}_filtered.fastq

#run QC with fastp
#fastp --in1 $f1 --in2 $f2 --out1 ${file_base}_L001_R1_001_trimmed.fastq --out2 ${file_base}_L001_R2_001_trimmed.fastq -l 50 -h ${file_base}_QC.html

#new read output
#f1=${file_base}_L001_R1_001_trimmed.fastq
#f2=${file_base}_L001_R2_001_trimmed.fastq
...
minimap2 -ax map-ont $reference_genome $f1 | samtools view -Shb -F 0x100 -F 0x800 | samtools sort -o ${file_base}_sorted.bam
