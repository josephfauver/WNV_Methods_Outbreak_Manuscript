...
reference_genome=NC_009942.fasta
primer_bed=WNVUS1.bed
...
f1=${file_base}_L001_R1_001.fastq.gz
f2=${file_base}_L001_R2_001.fastq.gz
...
samtools mpileup -A -d 1000 -Q 0 ${file_base}_aln_trimmed_sorted.bam | ivar consensus -t 0.50 -m 10 -p ${file_base}_consensus
